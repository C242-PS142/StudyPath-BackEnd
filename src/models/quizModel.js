...
exports.saveRecomend = function(id, data, callback) {
    function extractOneData(text, personality) {
        const regex = new RegExp(`\\${personality} \\((\\d+)%\\)\\n(.*?)\\n\\nRekomendasi:(.*?)\\n`, 'gms');
    ...
    personalities = ['Keterbukaan Terhadap Pengalaman', 'Kestabilan Emosi', 'Keterbukaan Sosial, Energi, dan Antusiasme', 'Ketelitian', 'Kesepakatan']
    const locker = [];
